...
2. `docs/atlas.md`의 **키 관리와 로컬 환경**, **배포와 운영 명령** — 키 위치·운영 리소스·검증 절차.
3. `docs/collector.md` — 수집 계약·중단 경계·압축 실측.
4. `docs/implementation.md` — 실제 작업·검증 기록. 오래된 기록을 현재 상태로 해석하지 않는다.
